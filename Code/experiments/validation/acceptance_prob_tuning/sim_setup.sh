...
if [ "$(uname)" == "Darwin" ]; then
    ...
    Rscript "Code/experiments/validation/acceptance_prob_tuning/run_sim.R
else
    ...
    conda activate ed_ip_simulation
    singularity exec --bind "/scratch/:/scratch/,/work/:/work/" /shared/container_repository/rstudio/rocker-geospatial-4.2.1.sif Rscript "Code/experiments/validation/acceptance_prob_tuning/run_sim.R
fi
